    ...
    <section className="py-20 texture-paper">
      <div className="container mx-auto px-6">
        <div className="text-center mb-16 max-w-2xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-black text-[#2f9e41] mb-4 brand-font">
            Tudo o que você precisa no campo
          </h2>
          <p className="text-lg text-slate-600">
            Esqueça o caderno e a caneta. Tenha o controle total da sua fazenda
            na palma da mão.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="bg-white p-8 rounded-xl shadow-lg border-b-4 border-[#d97706] hover:-translate-y-2 transition-transform duration-300">
            ...
            <h3 className="text-xl font-bold text-[#2f9e41] mb-3 brand-font">
              Controle de Rebanho
            </h3>
          ...
          {/* Benefício 2 */}
          <div className="bg-white p-8 rounded-xl shadow-lg border-b-4 border-[#2f9e41] hover:-translate-y-2 transition-transform duration-300 relative overflow-hidden">
            ...
            <h3 className="text-xl font-bold text-[#2f9e41] mb-3 brand-font relative z-10">
            ...
            {/* Detalhe decorativo */}
            <div className="absolute -right-10 -bottom-10 w-32 h-32 bg-[#2f9e41] opacity-5 rounded-full"></div>
          </div>
