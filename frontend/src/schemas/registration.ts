...
import { emailRule, passwordRule, nameRule, cpfRule, phoneRule } from "./auth";

// ===========================
// SCHEMAS DE LOCATION
// ===========================

export const stateRule = z
  .string()
  .length(2, "Estado deve ser a sigla (UF) com 2 letras");
...
export const producerStep1Schema = z
  .object({
    name: nameRule,
    email: emailRule,
    password: passwordRule,
