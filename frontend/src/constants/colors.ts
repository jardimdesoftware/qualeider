...
export const colors = {
  // Brand Colors
  brand: {
    primary: "#2f9e41", // Verde institucional (Instituto Federal, Pantone 362C)
    primaryHover: "#237a32", // Verde institucional, hover
    secondary: "#d97706", // Laranja/Âmbar destaque
    accent: "#fbbf24", // Amarelo/Dourado claro
    emphasis: "#cd191e", // Vermelho de ênfase pontual (Instituto Federal, Pantone 187C)
  },
