...
| **Docker Compose Unificado**        | Containers para Frontend, Backend, Nginx e PostgreSQL | Facilita configuração de ambiente e paridade dev/prod                                          | Exige Docker Desktop; simula ambiente de produção com Proxy Reverso                                                                                                                             |
...
5. **Docker Compose Unificado** para dev (com Nginx) ao invés de Kubernetes → Simplicidade + simulação de prod
...
| ---------------------------- | ---------------------------------- | --------------------------- | ------------------------------------------------------- | ----------------------------------------------- |
| **Cliente ↔ Nginx (Proxy)**  | HTTP/1.1 (REST/Static)             | JSON / HTML                 | -                                                       | 8080 (Dev)<br>80/443 (Prod)                     |
| **Nginx ↔ API Backend**      | HTTP/1.1 (REST)                    | JSON (application/json)     | JWT HS256 (Bearer Token)                                | 3000<br>`/api/*`                                |
| **Nginx ↔ Frontend**         | HTTP/1.1                           | HTML / JS                   | -                                                       | 3000                                            |
