...
export class AssociationMapper {
    ...
    static toPrisma(association: AssociationEntity): PrismaAssociation {
        return {
            ...
            zipCode: association.zipCode ?? null,
            state: association.state,
            city: association.city,
            street: association.street ?? null,
            number: association.number ?? null,
            complement: association.complement ?? null,
            neighborhood: association.neighborhood ?? null,
            ...
            presidentName: association.presidentName ?? null,
            presidentCpf: association.presidentCpf ?? null,
            presidentEmail: association.presidentEmail ?? null,
            presidentPhone: association.presidentPhone ?? null,
