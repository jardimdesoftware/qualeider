...
import { MilkingPlace } from '../interfaces/daily-collection.interface';

export class UpdateDailyCollectionDto extends PartialType(CreateDailyCollectionDto) {
  @ApiProperty({ description: 'Total de leite coletados em litros', example: '25' })
  @IsNumber()
  quantity: number;
